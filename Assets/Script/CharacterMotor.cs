...
public class CharacterMotor : MonoBehaviour {
    ...
    // Le personage est-il mort ?
    public bool isDead; 

    // le personage est-il dans un magasin
    ...
    void Start () {
        ...
        Debug.Log(spellHolderImg);
        Debug.Log(raySpell);
    }

    bool IsGrounded()
    {
        return Physics.CheckCapsule(playerCollider.bounds.center, new Vector3(
            playerCollider.bounds.center.x,
            playerCollider.bounds.min.y - 0.1f, playerCollider.bounds.center.z), 0.08f, 9);
